...
نبني منصة سفر وسياحة متكاملة باسم "جولة" تجمع تحت سقف واحد قنوات البيع الرئيسية في السوق: موقع إلكتروني متجاوب يخدم الأفراد على كل الأجهزة (كمبيوتر وموبايل وتابلت)، وبوابة مخصصة لوكلاء السفر لبيع الجملة. باقة Enterprise هي الباقة الكاملة التي تفتح مصادر دخل متعددة في نفس الوقت بدلاً من الاعتماد على قناة بيع واحدة، وتسمح لنا بتأجير المنصة كعلامة بيضاء لشركات أخرى مقابل رسوم شهرية. هذا الاستثمار يحوّل "جولة" من موقع حجوزات إلى شركة تكنولوجيا سفر قادرة على المنافسة الإقليمية مع تكامل كامل مع منظومة Amadeus المؤسسية (Master Pricer، PNR/Ticketing الكامل، NDC، الخدمات الإضافية، Tours & Activities، Transfers، Cars).

### ماذا يحصل عليه العميل في هذه الباقة؟

- موقع إلكتروني متجاوب كامل لبيع تذاكر الطيران والفنادق والباقات السياحية للأفراد مباشرة، محسّن للعمل على الكمبيوتر والموبايل والتابلت من نفس الكود
...
- تكامل كامل مع منظومة Amadeus المؤسسية: Master Pricer للبحث المتقدم، PNR و Ticketing الكامل، NDC للأسعار المباشرة من شركات الطيران، الخدمات الإضافية (Ancillaries) مثل الأمتعة واختيار المقاعد، Tours & Activities للأنشطة، Transfers للنقل، و Cars لتأجير السيارات
...
| عدد قنوات البيع | قناتان (موقع ويب متجاوب + بوابة وكلاء B2B) |
| عدد الموظفين المطلوبين | فريق متكامل من المطورين ومدير منتج ومسؤول عمليات (يُحدَّد التفصيل في خطة الموارد) |
| العائد المتوقع على الاستثمار خلال 12 شهر | استرداد قيمة الاستثمار مع تحقيق هامش ربح معقول من قنوات البيع المتعددة (نموذج محافظ نظراً للنطاق المخفّض) |
...
- التكامل الكامل مع منظومة Amadeus المؤسسية يفتح كل مصادر المخزون والإيرادات الإضافية (Ancillaries، Tours، Transfers، Cars) في معاملة واحدة، ويرفع متوسط قيمة الحجز
...
- التواجد على قناتين بيع متكاملتين في نفس الوقت يقلل اعتمادنا على قناة واحدة ويزيد استقرار الإيرادات
...
| قائد التصميم | لم يحدد بعد - Design Director (للويب وبوابة B2B) |
...
2. **توسيع القنوات**: موقع ويب متجاوب بتجربة كاملة على كل الأجهزة (كمبيوتر، تابلت، موبايل) بدون الحاجة لتطبيقات منفصلة؛ وبوابة مخصصة لوكلاء B2B بإدارة الـ markup ومحاسبة العمولات وحدود ائتمان.
...
باقة Enterprise قصدًا هي استثمار يمتد عدة أرباع سنوية. لازم تتعامل معها كسلسلة من خطوط العمل المتكاملة عموديًا، مش كقائمة ميزات تنفذ بالتتابع. خطوط العمل تشمل: B2B، Packages، التسعير الديناميكي، الاحتيال، White-Label، المجموعات/الشركات، الفروع المتعددة. كل خط له قائد هندسي، قائد تصميم، وبوابة قبول خاصة بيه.
...
2. **تنويع القنوات**: على الأقل 25% من GBV من B2B (وكلاء + شركات) خلال 12 شهر.
...
شخصيات Basic و Professional لسه فعّالة. Enterprise تضيف 6 شخصيات جديدة لازم المنصة تخدمهم كمستخدمين أساسيين.
...
| الميزة | محمد | رانيا | كريم | هشام | سلمى | حسن | ليلى ن. | شريف |
|---------|---------|-------|-------|--------|-------|--------|----------|--------|
| بوابة B2B | أساسي | ثانوي | - | مطلوب | - | - | - | يلاحظ |
| Tour Packages | ثانوي | ثانوي | أساسي | مطلوب | - | - | - | استراتيجي |
| حجوزات المجموعات | ثانوي | ثانوي | أساسي | مطلوب | - | - | - | - |
| حسابات الشركات | - | أساسي | - | مطلوب | - | - | - | - |
| فروع متعددة | - | - | - | مطلوب | أساسية | - | تدقق | - |
| التسعير الديناميكي | يستفيد | - | - | مطلوب | - | - | - | استراتيجي |
| White-Label | - | - | - | أساسي | - | - | تدقق | استراتيجي |
| كشف الاحتيال | محمي | محمية | محمي | مطلوب | - | أساسي | تدقق | - |
...
القصص بتكمل من US-001..US-038 (الموروثة من Basic و Professional). Enterprise تضيف US-039 إلى US-090 (مع حذف القصص الخاصة بتطبيقات الموبايل US-051..US-057).
...
- AC-082.1: حجوزات اليوم + GBV + الإيراد، مزيج القناة (B2C، B2B، white-label)، أعلى المستأجرين، أعلى المشاكل.
...
|---------|----------|------|-----------|--------|--------------|
| M0 - توقيع العقد | SOW موقع، انطلاق تنفيذي، تجميع الفريق الكامل، استمرار مستشار Amadeus، بدء قوالب white-label القانونية | اليوم 0 | تنفيذ العقد | 18% | 180,000 |
| M1 - الاكتشاف والمعمارية والتصميم | معمارية لكل خط عمل (B2B، packages، تسعير ديناميكي، white-label، احتيال، مجموعات/شركات، فروع متعددة)؛ مكتبة Figma كاملة للويب المتجاوب وبوابة B2B والأدمن؛ خارطة طريق الامتثال؛ نموذج السعة؛ هيكل الفريق نهائي | الأسابيع 1-3 | قبول M1 | 10% | 100,000 |
| M2 - المنصة والأساسيات | Kubernetes (أو orchestrator مختار) جاهز؛ stack القابلية للملاحظة؛ schema DB متعدد المستأجرين؛ إطار RBAC؛ منصة feature flag | الأسابيع 3-7 | اختبار smoke للمنصة ينجح | 14% | 140,000 |
| M3 - Packages والتسعير الديناميكي | كتالوج packages جاهزة + حجز؛ packaging ديناميكي (باقة flight+hotel)؛ package admin builder؛ محرك قواعد التسعير الديناميكي؛ تعديلات حسب الطلب؛ dashboard ارتفاع الإيراد | الأسابيع 7-11 | حجز package من البداية للنهاية + إثبات قاعدة تسعير | 14% | 140,000 |
| M4 - بوابة وكلاء B2B | تقديم/انضمام الوكلاء؛ تدفق حجز الوكيل؛ إدارة markup؛ حدود ائتمان؛ كشوف عمولات؛ إدارة مستخدمين فرعيين؛ تقارير B2B | الأسابيع 9-13 | أول 5 وكلاء شركاء جاهزين ويحجزون في staging | 14% | 140,000 |
| M5 - المجموعات والشركات والفروع المتعددة | تدفق حجز المجموعات؛ حسابات الشركات بالسياسة + المعتمد؛ فواتير موحدة؛ كيانات الفروع؛ P&L الفروع؛ مبيعات counter؛ تسوية الكاش | الأسابيع 13-17 | حجز مجموعة حي تم؛ أول حساب شركة + أول فرع عامل | 12% | 120,000 |
| M6 - White-Label والاحتيال | تجهيز مستأجر white-label؛ أدمن معزول لكل مستأجر؛ تهيئة gateway لكل مستأجر؛ فواتير الشركاء؛ محرك تقييم الاحتيال؛ قائمة مراجعة الاحتيال؛ إدارة chargeback؛ نموذج ML v1 مدرّب | الأسابيع 15-20 | أول مستأجر white-label جاهز ببيانات وهمية؛ تقييم الاحتيال على 100% من الحجوزات | 10% | 100,000 |
| M7 - الامتثال والتقوية والإطلاق | معالجة فجوات PCI DSS؛ نشر ضوابط SOC 2؛ خدمة ذاتية DSR؛ UAT كامل (600+ حالة)؛ load test 10k متزامن؛ نشر إنتاج؛ 4 أسابيع رعاية مكثفة | الأسابيع 20-24 | الإنتاج حي؛ تقرير تحليل فجوات PCI مسلّم | 8% | 80,000 |
| **الإجمالي** | | **20-24 أسبوع** | | **100%** | **1,000,000** |

### معايير قبول المراحل التفصيلية

**قبول M1**
- مستندات معمارية لكل خط عمل (7 خطوط) مراجَعة وموقّعة.
- مكتبة Figma كاملة للويب المتجاوب + B2B + الأدمن (تقدير 150+ إطار).
...
| OQ-084 | التزام الوصولية - WCAG 2.1 AA على كل السطوح (ويب، بوابة B2B، أدمن)؟ | Product + Legal | M1 |
...
| OQ-090 | وظيفة نجاح العملاء - فيه فريق CS للعملاء عاليي القيمة (شركات، أعلى وكلاء B2B)؟ | Operations | M6 |
